...
savings = int(input("How much money would you like to set up your savings
account with: "))
checking = int(input("How much money would you like to set up your checking
account with: "))
...
print("\nDeposited $" + str(money) + " into " + bank_account['Name'] + "'s "
...
bank_account[account] -= money
print("\nWithdrew $" + str(money) + " from " + bank_account['Name'] + "'s
" + account.lower() + " account.")
#Not enough money in the account to make the withdrawal
else:
print("\nSorry, by withdrawing $" + str(money) + " you will have a
negative balance.")
...
account_type = input("\nWhat account would you like to access (Savings or
Checking): ").title()

choice = input("What type of transaction would you like to make (Deposit or
Withdrawal): ").title()
